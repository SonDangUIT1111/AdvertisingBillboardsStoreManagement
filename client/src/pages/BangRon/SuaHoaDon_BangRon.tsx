...
import { BangRonBillInput } from "../../network/bangRonBill_api";
...
export function SuaHoaDon_BangRon() {
  ...
  async function loadBangRonBill() {
    try {
      ...
      await BangRonBillApi.fetchBangRonBill(idBill).then((data) => {
  ...
  async function onSubmit(input: BangRonBillInput) {
    try {
      if (typeof idBill === "undefined") idBill = "";
      await BangRonBillApi.updateBangRonBill(idBill, input);
